...
Every setting is required, so that "configured" is one state rather than two. A
partial file that happened to satisfy whichever command ran first would leave
